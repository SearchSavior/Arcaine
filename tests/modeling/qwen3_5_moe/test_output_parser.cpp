// Pass-through check for the qwen3_5_moe output_parser (no GPU). The full
// MoE-native tool-call parser is deferred; for now the parser returns the
...
using namespace arcaine::qwen3_5_moe;
