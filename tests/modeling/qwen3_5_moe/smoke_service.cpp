// GPU smoke test for the qwen3_5_moe ModelService. Loads through the new
...
//   build/tests/arcaine_smoke_qwen_moe /workspace/models/Qwen-AgentWorld-35B-A3B-NVFP4
...
int main(int argc, char** argv) {
    ...
    req.served_model_name = "qwen3.5-moe";
