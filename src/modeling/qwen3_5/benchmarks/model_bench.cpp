// qwen3_5 — model-owned inference benchmark (llama-bench approach).
...
// arcaine_mbench dispatcher as "qwen3_5" (matches config.json::model_type).
//
...
static int run(int argc, char* argv[]) {
    ...
    double t0 = now_ms();
    Qwen35Model model(args.model, max_seq);
...
REGISTER_MODEL_BENCH("qwen3_5", "Qwen3.5 AR DeltaNet (llama-bench pp/tg KV-depth throughput)", run)
