...
int main(int argc, char** argv) {
    ...
    std::string spv_path = "ngen_lab/ovino/gdn_seq_scalar.spv";
    int iters = 5;
    ...
    ze_kernel_desc_t kdesc{ZE_STRUCTURE_TYPE_KERNEL_DESC, nullptr, 0, "gdn_seq_scalar"};
    ...
    for (int T : tokens) {
        ...
        ze_group_count_t gc{nv, vblocks, 1};
        for (int i = 0; i < 2; ++i) {
        ...
        std::printf("ovino_scalar p=%d runs=%d mean_ms=%.3f tok_per_s=%.1f "
